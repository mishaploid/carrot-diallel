# ------------------------------------------------------------------------------
#   Plot phenotypic correlations - Fig2A
#   S. Turner 
#   06 January 2017       
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
correlation <- cor(diallelRaw[,c(9:17)], method = "pearson", 
                   use = "complete.obs")
...
# ------------------------------------------------------------------------------
p.mat <- cor.mtest(diallelRaw[,c(9:17)])
...
ggsave("~/GitHub/carrot-diallel/results/phenotypic_correlations.eps", height = 150, 
       width = 150, units = "mm")
